...
describe('controller', function () {
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			...
			//update model to keep count 
			//jasmine.any(Function) => jasmine.any takes a constructor or "class" name as an expected value. 
		...
		it('should update the view', function () {
			// TODO: write test
			//All the todos are completed, item left has total of 1 by default
			var todos = [{id:42, title: 'my todo', completed: false},
						 {id:43, title: 'new todo', completed: false}];
